...
@testset "15 keV vs 20 keV" begin    
    ...
    @test isapprox(value(m20[n"O"]), 0.4403, atol=0.0001)
    @test isapprox(value(m20[n"Mg"]), 0.1145, atol=0.0001)
    ...
    @test isapprox(value(m15[n"Al"]), 0.0484, atol=0.0001)
    ...
    @test isapprox(value(m15_20[n"Mg"]), 0.1174, atol=0.0001)
    @test isapprox(value(m15_20[n"Al"]), 0.0487, atol=0.0001)
    ...
    @test isapprox(value(m20_15[n"O"]), 0.4279, atol=0.0001)
    @test isapprox(value(m20_15[n"Mg"]), 0.1127, atol=0.0001)
    @test isapprox(value(m20_15[n"Al"]), 0.0479, atol=0.0001)
    @test isapprox(value(m20_15[n"Si"]), 0.2092, atol=0.0001)
