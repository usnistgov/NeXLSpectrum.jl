...
@testset "K2496" begin
    ...
    @test isapprox( value(fs_stds.kratios, kl[ok]), 0.977768, atol=1.0e-6) 
    @test isapprox( σ(fs_stds.kratios, kl[ok]), 0.000818949, atol=1.0e-6) 
    bal = findfirst(l->n"Ba L3-M5" in l.xrays, kl)
    @test isapprox( value(fs_stds.kratios, kl[bal]), 0.821597, atol=1.0e-6) 
    @test isapprox( σ(fs_stds.kratios, kl[bal]), 0.00142848, atol=1.0e-6) 
    tik = findfirst(l->n"Ti K-L3" in l.xrays, kl)
    @test isapprox( value(fs_stds.kratios, kl[tik]), 0.022261, atol=1.0e-6) 
    @test isapprox( σ(fs_stds.kratios, kl[tik]), 0.000265, atol=1.0e-6) 
    q=material(quantify(fs_stds))
    @test isapprox(value(q[n"O"]), 0.307652, atol=1.0e-6)
    @test isapprox(value(q[n"Si"]), 0.221914, atol=1.0e-6)
    @test isapprox(value(q[n"Ti"]), 0.022948, atol=1.0e-6)
    @test isapprox(value(q[n"Ba"]), 0.423878, atol=1.0e-6)
    ...
    @test isapprox( value(fs_stds2.kratios, kl[ok]), 0.977768, atol=1.0e-6) 
    @test isapprox( σ(fs_stds2.kratios, kl[ok]), 0.000818949, atol=1.0e-6) 
    @test isapprox( value(fs_stds2.kratios, kl[bal]), 0.821597, atol=1.0e-6) 
    @test isapprox( σ(fs_stds2.kratios, kl[bal]), 0.00142848, atol=1.0e-6) 
    @test isapprox( value(fs_stds2.kratios, kl[tik]), 0.022261, atol=1.0e-6) 
    @test isapprox( σ(fs_stds2.kratios, kl[tik]), 0.000265, atol=1.0e-6) 
