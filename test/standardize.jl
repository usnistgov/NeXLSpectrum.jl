...
@testset "K2496" begin
    ...
    @test isapprox( value(fs_stds.kratios, kl[bal]), 0.821569, atol=1.0e-5) 
    @test isapprox( σ(fs_stds.kratios, kl[bal]), 0.00142848, atol=1.0e-5) 
    tik = findfirst(l->n"Ti K-L3" in l.xrays, kl)
    @test isapprox( value(fs_stds.kratios, kl[tik]), 0.022261, atol=1.0e-5) 
    @test isapprox( σ(fs_stds.kratios, kl[tik]), 0.000265, atol=1.0e-5) 
    q=material(quantify(fs_stds))
    @test isapprox(value(q[n"O"]), 0.307701, atol=1.0e-5)
    @test isapprox(value(q[n"Si"]), 0.221914, atol=1.0e-5)
    @test isapprox(value(q[n"Ti"]), 0.023031, atol=1.0e-5)
    @test isapprox(value(q[n"Ba"]), 0.423953, atol=1.0e-5)
    ...
    @test isapprox( value(fs_stds2.kratios, kl[bal]), 0.8215698, atol=1.0e-5) 
    @test isapprox( σ(fs_stds2.kratios, kl[bal]), 0.00142848, atol=1.0e-5) 
    @test isapprox( value(fs_stds2.kratios, kl[tik]), 0.022261, atol=1.0e-5) 
