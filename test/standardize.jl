...
@testset "K2496" begin
    ...
    @test isapprox( value(fs_stds.kratios, kl[bal]), 0.821597, atol=1.0e-5) 
    ...
    @test isapprox(value(q[n"O"]), 0.307652, atol=1.0e-5)
    @test isapprox(value(q[n"Si"]), 0.221914, atol=1.0e-5)
    @test isapprox(value(q[n"Ti"]), 0.022948, atol=1.0e-5)
    @test isapprox(value(q[n"Ba"]), 0.423878, atol=1.0e-5)
    ...
    @test isapprox( value(fs_stds2.kratios, kl[bal]), 0.821597, atol=1.0e-5) 
