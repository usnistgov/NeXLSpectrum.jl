...
@testset "DirectFit" begin
    ...
    @test isapprox(mean(df[:, "k[O K-L3 + 1 other, SiO2]"]), 0.639310, atol=1.0e-6)
    @test isapprox(mean(df[:, "k[Fe L3-M5 + 13 others, Fe]"]), 0.0274458, atol=1.0e-6)
    @test isapprox(mean(df[:, "k[Mg K-L3 + 1 other, MgO]"]), 0.148241, atol=1.0e-6)
    @test isapprox(mean(df[:, "k[Al K-L3 + 3 others, Al2O3]"]), 0.0682467, atol=1.0e-6)
    @test isapprox(mean(df[:, "k[Si K-L3 + 3 others, SiO2]"]), 0.3535589, atol=1.0e-6)
    ...
    @test isapprox(mean(qdf[:, "O"]), 0.435035, atol=1.0e-6)
    @test isapprox(mean(qdf[:, "Mg"]), 0.115604, atol=1.0e-6)
    @test isapprox(mean(qdf[:, "Al"]), 0.0490904, atol=1.0e-6)
    @test isapprox(mean(qdf[:, "Si"]), 0.20908527, atol=1.0e-6)
    @test isapprox(mean(qdf[:, "Ca"]), 0.1086263, atol=1.0e-6)
    @test isapprox(mean(qdf[:, "Fe"]), 0.0795513, atol=1.0e-6)
