...
NeXLUncertainties.value(label::ReferenceLabel, ffr::FitResult) = value(label, ffr.kratios)
...
Base.values(lbl::ReferenceLabel, ffrs::Vector{<:FitResult}) = [value(lbl, ffr.kratios, 0.0) for ffr in ffrs]
